...
module USBFS_v3_20_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("d9167920-ad54-420b-8d21-b8b813384a2b/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d9167920-ad54-420b-8d21-b8b813384a2b/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
// ADC_SAR_v3_10(ADC_Clock=0, ADC_Clock_Frequency=8842106, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=true, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=true, Sample_Precharge=6, Sample_Rate=0, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq_1:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=ADC_SAR_Seq_1_SAR, )
module ADC_SAR_v3_10_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("c88e8d24-08fe-4e5c-ba95-52bf7bdeaf83/dea208d9-07b0-438b-a5e0-ac5d207f2658/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// ADC_SAR_SEQ_v2_10(ADC_Clock_Frequency=1866648, Adjust=0, ClockSource=0, InputRange=1, NumChannels=2, Reference=1, Resolution=8, rm_int=false, SampleMode=0, SamplePrecharge=6, SampleRate=133332, SampleRate_def=631579, VrefValue=2.5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_Seq_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=ADC_SAR_Seq_1, )
module ADC_SAR_SEQ_v2_10_3 (
	...
	cy_clock_v1_0
		#(.id("c88e8d24-08fe-4e5c-ba95-52bf7bdeaf83/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("c88e8d24-08fe-4e5c-ba95-52bf7bdeaf83/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
	...
	wire [0:0] tmpOE__Y_Button_net;
	wire [0:0] tmpFB_0__Y_Button_net;
	wire [0:0] tmpIO_0__Y_Button_net;
	wire [0:0] tmpINTERRUPT_0__Y_Button_net;
	electrical [0:0] tmpSIOVREF__Y_Button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Y_Button
		 (.oe(tmpOE__Y_Button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Y_Button_net[0:0]}),
		  .io({tmpIO_0__Y_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__Y_Button_net),
		  .interrupt({tmpINTERRUPT_0__Y_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Y_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__X_Button_net;
	wire [0:0] tmpFB_0__X_Button_net;
	wire [0:0] tmpIO_0__X_Button_net;
	wire [0:0] tmpINTERRUPT_0__X_Button_net;
	electrical [0:0] tmpSIOVREF__X_Button_net;

	cy_psoc3_pins_v1_10
		#(.id("fa2b44a5-2d46-4f78-9357-f8dfa6fcbed3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		X_Button
		 (.oe(tmpOE__X_Button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__X_Button_net[0:0]}),
		  .io({tmpIO_0__X_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__X_Button_net),
		  .interrupt({tmpINTERRUPT_0__X_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__X_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__B_Button_net;
	wire [0:0] tmpFB_0__B_Button_net;
	wire [0:0] tmpIO_0__B_Button_net;
	wire [0:0] tmpINTERRUPT_0__B_Button_net;
	electrical [0:0] tmpSIOVREF__B_Button_net;

	cy_psoc3_pins_v1_10
		#(.id("b8387398-5fc3-4a78-904a-9962fc99e7a7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Start_Button_net;
	wire [0:0] tmpFB_0__Start_Button_net;
	wire [0:0] tmpIO_0__Start_Button_net;
	wire [0:0] tmpINTERRUPT_0__Start_Button_net;
	electrical [0:0] tmpSIOVREF__Start_Button_net;

	cy_psoc3_pins_v1_10
		#(.id("ae2a92d0-9848-4516-975d-2d6b5c1f09df"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Start_Button
		 (.oe(tmpOE__Start_Button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Start_Button_net[0:0]}),
		  .io({tmpIO_0__Start_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__Start_Button_net),
		  .interrupt({tmpINTERRUPT_0__Start_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Start_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Select_Button_net;
	wire [0:0] tmpFB_0__Select_Button_net;
	wire [0:0] tmpIO_0__Select_Button_net;
	wire [0:0] tmpINTERRUPT_0__Select_Button_net;
	electrical [0:0] tmpSIOVREF__Select_Button_net;

	cy_psoc3_pins_v1_10
		#(.id("ba3a37d0-2677-4a6e-8b6c-fdae4a2ba97d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Select_Button
		 (.oe(tmpOE__Select_Button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Select_Button_net[0:0]}),
		  .io({tmpIO_0__Select_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__Select_Button_net),
		  .interrupt({tmpINTERRUPT_0__Select_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Select_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("64a66478-7002-49a0-80c8-a40a1cc1a65f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__R_Button_net;
	wire [0:0] tmpFB_0__R_Button_net;
	wire [0:0] tmpIO_0__R_Button_net;
	wire [0:0] tmpINTERRUPT_0__R_Button_net;
	electrical [0:0] tmpSIOVREF__R_Button_net;

	cy_psoc3_pins_v1_10
		#(.id("e5174dc7-2835-4b7c-8ef7-0f034831e3b5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		R_Button
		 (.oe(tmpOE__R_Button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__R_Button_net[0:0]}),
		  .io({tmpIO_0__R_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__R_Button_net),
		  .interrupt({tmpINTERRUPT_0__R_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__R_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__L_Button_net;
	wire [0:0] tmpFB_0__L_Button_net;
	wire [0:0] tmpIO_0__L_Button_net;
	wire [0:0] tmpINTERRUPT_0__L_Button_net;
	electrical [0:0] tmpSIOVREF__L_Button_net;

	cy_psoc3_pins_v1_10
		#(.id("49214d18-7c5d-45b8-a75d-acbe0c8c9e41"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		L_Button
		 (.oe(tmpOE__L_Button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__L_Button_net[0:0]}),
		  .io({tmpIO_0__L_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__L_Button_net),
		  .interrupt({tmpINTERRUPT_0__L_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__L_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
