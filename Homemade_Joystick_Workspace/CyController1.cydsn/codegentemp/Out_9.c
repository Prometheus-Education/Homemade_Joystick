...
*
* \funcusage
*  \snippet Out_9_SUT.c usage_Out_9_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Out_9_SUT.c usage_Out_9_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Out_9_SUT.c usage_Out_9_Read  
*******************************************************************************/
...
* preferred Out_9_Read() API because the 
* Out_9_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Out_9_SUT.c usage_Out_9_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Out_9_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Out_9_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Out_9_0_INTR       (First pin in the list)
    *  - Out_9_1_INTR       (Second pin in the list)
    *  - ...
    *  - Out_9_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Out_9_SUT.c usage_Out_9_SetInterruptMode
    *******************************************************************************/
    void Out_9_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Out_9_0_INTR) != 0u) 
		{ 
			 Out_9_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Out_9_SUT.c usage_Out_9_ClearInterrupt
    *******************************************************************************/
