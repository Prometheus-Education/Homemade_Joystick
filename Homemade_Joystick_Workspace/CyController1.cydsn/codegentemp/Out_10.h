...
void    Out_10_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Out_10_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Out_10__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Out_10_SetInterruptMode() function.
     *  @{
     */
        #define Out_10_INTR_NONE      (uint16)(0x0000u)
        #define Out_10_INTR_RISING    (uint16)(0x0001u)
        #define Out_10_INTR_FALLING   (uint16)(0x0002u)
        #define Out_10_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Out_10_INTR_MASK      (0x01u) 
#endif /* (Out_10__INTSTAT) */
...
/* SIO registers */
#if defined(Out_10__SIO_CFG)
    #define Out_10_SIO_HYST_EN        (* (reg8 *) Out_10__SIO_HYST_EN)
    #define Out_10_SIO_REG_HIFREQ     (* (reg8 *) Out_10__SIO_REG_HIFREQ)
    #define Out_10_SIO_CFG            (* (reg8 *) Out_10__SIO_CFG)
    #define Out_10_SIO_DIFF           (* (reg8 *) Out_10__SIO_DIFF)
#endif /* (Out_10__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Out_10_0_INTTYPE_REG 		(* (reg8 *) Out_10__0__INTTYPE)
#endif /* (Out_10__INTSTAT) */
