...
*
*  Button_1_DM_STRONG     Strong Drive 
*  Button_1_DM_OD_HI      Open Drain, Drives High 
*  Button_1_DM_OD_LO      Open Drain, Drives Low 
*  Button_1_DM_RES_UP     Resistive Pull Up 
*  Button_1_DM_RES_DWN    Resistive Pull Down 
*  Button_1_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Button_1_DM_DIG_HIZ    High Impedance Digital 
*  Button_1_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
*  
* Note:
*  Macro Button_1_ReadPS calls this function. 
*  
*******************************************************************************/
