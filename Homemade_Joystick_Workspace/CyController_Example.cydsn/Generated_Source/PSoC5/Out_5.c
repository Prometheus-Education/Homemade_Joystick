...
*
* \funcusage
*  \snippet Out_5_SUT.c usage_Out_5_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Out_5_SUT.c usage_Out_5_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Out_5_SUT.c usage_Out_5_Read  
*******************************************************************************/
...
* preferred Out_5_Read() API because the 
* Out_5_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Out_5_SUT.c usage_Out_5_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Out_5_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Out_5_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Out_5_0_INTR       (First pin in the list)
    *  - Out_5_1_INTR       (Second pin in the list)
    *  - ...
    *  - Out_5_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Out_5_SUT.c usage_Out_5_SetInterruptMode
    *******************************************************************************/
    void Out_5_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Out_5_0_INTR) != 0u) 
		{ 
			 Out_5_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Out_5_SUT.c usage_Out_5_ClearInterrupt
    *******************************************************************************/
